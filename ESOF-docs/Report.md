...
O Tomahawk permite ainda o armazenamento de ficheiros de media em *clouds*, disponibilizando ainda uma interface que permite a comunicação entre diversos utilizadores da aplicação.
